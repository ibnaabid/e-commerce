...
export default function WhatsAppBtn({ product }) {
  // 📱 ফোন নাম্বার থেকে সব স্পেস এবং ড্যাশ ডাইনামিকালি মুছে ক্লিন নাম্বার তৈরি করা হয়েছে
  const rawPhoneNumber = "880 1823-633271"; 
  const phoneNumber = rawPhoneNumber.replace(/[^0-9]/g, ""); // আউটপুট হবে: "8801823633271"

  // 📦 প্রোডাক্ট পাওয়া গেছে কিনা চেক করা
  ...
  // 💬 প্রোডাক্ট থাকলে আইডি সহ মেসেজ, না থাকলে জেনারেল মেসেজ
