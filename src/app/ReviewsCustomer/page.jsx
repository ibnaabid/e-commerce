            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  {/* Review Text */}
                  <p className="text-black text-sm sm:text-base leading-relaxed italic mb-6">
                    "{rev.comment}"
                  </p>
                </div>
